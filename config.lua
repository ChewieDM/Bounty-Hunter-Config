...
BountyMissions = {
	...
	[32] = {
		...
		spawnenemies = {
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 2, accuracy = 50},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 2, accuracy = 70},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 3, accuracy = 30},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 2, accuracy = 10},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 3, accuracy = 60},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 2, accuracy = 50},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 2, accuracy = 70},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 3, accuracy = 80},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 2, accuracy = 70},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 3, accuracy = 80},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 3, accuracy = 80},
			{x = , y = , z = , weapon ="WEAPON_REPEATER_CARBINE", style = 3, accuracy = 80},
