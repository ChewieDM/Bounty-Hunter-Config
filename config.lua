...
BountyMissions = {
	...
	[30] = {
		...
		spawnenemies = {
			...
			{x = 2259.24, y = -773.41, z = 42.98, weapon ="WEAPON_REPEATER_WINCHESTER", style = 1, accuracy = 80},
			...
			{x = 2285.43, y = -754.06, z = 41.80, weapon ="WEAPON_PISTOL_MAUSER", style = 3, accuracy = 90}, 
			{x = 2297.01, y = -757.28, z = 41.86, weapon ="WEAPON_PISTOL_MAUSER", style = 3, accuracy = 90},
			{x = 2298.36, y = -743.57, z = 41.22, weapon ="WEAPON_REVOLVER_SCHOFIELD_GOLDEN", style = 3, accuracy = 90}, 
			{x = 2300.03, y = -748.50, z = 41.76, weapon ="WEAPON_REVOLVER_SCHOFIELD_GOLDEN", style = 3, accuracy = 90},  
	...
	[33] = {
		...
		spawnenemies = {
			...
			{x = -2324.34, y = 92.46, z = 221.34, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2322.08, y = 90.55, z = 221.46, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2319.52, y = 87.59, z = 221.58, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2322.45, y = 85.71, z = 221.10, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2324.26, y = 87.89, z = 221.02, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2327.27, y = 89.01, z = 220.74, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2329.69, y = 86.43, z = 220.18, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2328.35, y = 82.22, z = 219.83, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			{x = -2326.04, y = 77.90, z = 219.93, weapon ="WEAPON_REVOLVER_LEMAT", style = 2, accuracy = 75}, 
			}
		},
	[34] = {
		firstname = "Lendaria",
