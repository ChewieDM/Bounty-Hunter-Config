...
Texts = {
    ...
    ["bm_enemiesband"] = "Complete sua missão, você chegou ao local onde está",
    ...
    ["bm_finishoutlaw"] = "Você conseguiu matar todos os vilões, volte para a estação do xerife para receber sua recompensa!",
